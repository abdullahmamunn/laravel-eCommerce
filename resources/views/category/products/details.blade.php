                        ...
                        <div clas="single-top">
                            <div class="single-left">
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li data-thumb="{{asset($details->image)}}">
                                            <div class="thumb-image"> <img src="{{asset($details->image)}}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                                        <li data-thumb="{{asset($details->image)}}">
                                            <div class="thumb-image"> <img src="{{asset($details->image)}}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <p class="price item_price">$ {{$details->product_price}}</p>
