...
@section('content')
    ...
    <div class="content">
        <div class="products-agileinfo">
            <h2 class="tittle">{{ $category_name }}</h2>
            <div class="container">
                                                ...
                                                <div class="col-md-4 product-tab-grid simpleCart_shelfItem">
                                                    <div class="grid-arr">
                                                        <div  class="grid-arrival">
                                                            <figure>
                                                                <a href="{{route('product-details',['id'=>$categories->id])}}">
                                                                    <div class="grid-img">
                                                                        <img  src="{{asset($categories->image)}}" class="img-responsive" alt="">
                                                                    </div>
                                                                    <div class="grid-img">
                                                                        <img  src="{{asset($categories->image)}}" class="img-responsive"  alt="">
                                                                    </div>
                                                        ...
                                                        <div class="women">
                                                            ...
                                                            <a href="{{route('product-details',['id'=>$categories->id])}}" data-text="Add To Cart" class="my-cart-b item_add">Buy Now</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
