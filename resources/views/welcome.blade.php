        ...
        <div class="new-arrivals-w3agile">
            <div class="container">
                ...
                <div class="arrivals-grids">
                    @foreach($product as $newItems)
                    <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                        <div class="grid-arr">
                            <div  class="grid-arrival">
                                <figure>
                                    <a href="{{route('product-details',['id'=>$newItems->id])}}" class="new-gri" >
                                        <div class="grid-img">
                                            <img src="{{asset($newItems->image)}}" class="img-responsive" alt="" >
                                        </div>
                                        <div class="grid-img">
                                            <img src="{{asset($newItems->image)}}"  class="img-responsive" alt="" >
                                        </div>
                            ...
                            <div class="women">
                                <h6><a href="{{route('product-details',['id'=>$newItems->id])}}">{{$newItems->product_name}}</a></h6>
                                <span class="size">XL / XXL / S </span>
                                <p ><del>$100.00</del><em class="item_price"> ${{$newItems->product_price}}</em></p>
                                <a href="{{route('product-details',['id'=>$newItems->id])}}" data-text="Add To Cart" class="my-cart-b item_add">Buy Now</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
